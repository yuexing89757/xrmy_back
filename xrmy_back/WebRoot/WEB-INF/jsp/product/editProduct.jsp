...
<tr>
	<td>商品图片</td>
	<td>
		<c:if test="${news.newsType !=null}">
			<img src="/pic/${news.newsType}" width=100 height=100/>
			<br/>
		</c:if>
		<input type="file"  name="newsType"/> 
	</td>
</tr>
...
<tr>
	<td>商品简介</td>
	<td>
	<textarea rows="3" cols="30" name="content">${news.content }</textarea>
	</td>
</tr>
